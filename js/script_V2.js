	   ...
	   rawFile.onreadystatechange = function ()
	   {
	    ...
	    rawFile.send(null);
            ...
            if(new RegExp(recipe).test(jung[2])){
               output[i] = number+'. <a href="'+jung[3]+'"target="_blank" title="'+jung[3]+'">'+jung[2]+'</a> ('+jung[1]+'번째 요리)<br><a href="http://www.10000recipe.com/recipe/'+jung[5]+'" target="_blank">'+jung[4]+' title="http://www.10000recipe.com/recipe/'+jung[5]+'" width="20%"></a><br>';
               i += 1;
               number+=1;
            }
      }
...
function button1(choose){
  ...
  if(choose == 1){
    for(for_for=1;for_for<=4;for_for++){
      ...
      if(for_for !== 4){
          message = message+for_for+'. <a href="http://www.10000recipe.com'+jung2[1]+'"title="http://www.10000recipe.com'+jung2[1]+'"target="_blank">'+jung1[1]+'<br><img src="'+jung3[1]+'" width="20%"></a><br>';
      }
      else{
        message = message+for_for+'. <a href="http://www.10000recipe.com'+jung2[1]+'"title="http://www.10000recipe.com'+jung2[1]+'"target="_blank">'+jung1[1]+'<br><img src="'+jung3[1]+'" width="20%"></a>';
      }
    }
  }
  else{
