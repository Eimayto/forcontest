...
function button1(choose){
  ...
  if(choose == 1){
    for(for_for=1;for_for<=4;for_for++){
      ...
      if(for_for !== 4){
          message = message+for_for+'. <a href="http://www.10000recipe.com'+jung2[1]+'"title="http://www.10000recipe.com'+jung2[1]+'"target="_blank">'+jung1[1]+'<br><img src="'+jung3[1]+'" width="30%" alt="http://www.10000recipe.com/recipe/'+jung[5]+'"></a><br>';
      }
      else{
        message = message+for_for+'. <a href="http://www.10000recipe.com'+jung2[1]+'"title="http://www.10000recipe.com'+jung2[1]+'"target="_blank">'+jung1[1]+'<br><img src="'+jung3[1]+'" width="30%" alt="http://www.10000recipe.com/recipe/'+jung[5]+'"></a>';
      }
    }
  }
  else{
